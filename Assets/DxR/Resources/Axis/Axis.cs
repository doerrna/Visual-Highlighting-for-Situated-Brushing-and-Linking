...
namespace DxR
{
    public class Axis : MonoBehaviour
    {
        ...
        private readonly float baseTitleOffset = 0.008f;
        private float titleOffset = 0.008f;
        private float tickLabelOffset = 0.018f;
        ...
        {
            titleOffset = baseTitleOffset + titlePadding * DxR.Vis.SIZE_UNIT_SCALE_FACTOR;
        }
